...
# test remove dist_to_conv
train_df_linear <- train_df_linear[, !colnames(train_df_linear) %in% c("distance_to_convergence")]
test_df_linear <- test_df_linear[, !colnames(test_df_linear) %in% c("distance_to_convergence")]

linear_model_inital <- lm(price ~ ., data = train_df_linear)
summary(linear_model_inital)
```
...
predictions <- predict(linear_model_inital, newdata = test_df_linear)
